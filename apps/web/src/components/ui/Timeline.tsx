          ...
          return (
            <div key={index} className="relative flex items-start space-x-6 mb-8">
              ...
              <div className={`
                ...
                ${isCompleted ? 'bg-trueme-gold border-trueme-gold text-black' : ''}
                ${isCurrent ? 'bg-trueme-gold border-trueme-gold text-black animate-pulse' : ''}
                ...
                >
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      {isCurrent && (
                        <span className="px-2 py-1 text-xs bg-trueme-gold text-black rounded-full">
                          ACTUEL
                        </span>
                      )}
                    </div>

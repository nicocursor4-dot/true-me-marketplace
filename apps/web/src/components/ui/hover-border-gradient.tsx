...
>) {
  ...
  // Precomputed gradients (kept for reference if needed later)
  ...
  return (
    ...
    >
      <div
        className={cn(
          "w-auto text-black z-10 bg-gradient-to-br from-trueme-gold to-trueme-gold px-4 py-2 rounded-full",
          className
        )}
      >
        {children}

...
import { AnimatePresence, motion, useAnimation, useMotionValue, useTransform, cubicBezier } from "framer-motion"
...
const transitionOverlay = { duration: 0.5, ease: cubicBezier(0.32, 0.72, 0, 1) }
...
function ThreeDPhotoCarousel() {
  ...
  const cards = useMemo(() => keywords.map((keyword) => `https://picsum.photos/600/600?${keyword}`), [])
      ...
      <AnimatePresence mode="sync">
        {activeImg && (
          <motion.div
            ...
            onClick={handleClose}
            className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 m-5 md:m-36 lg:mx-[19rem] rounded-3xl"

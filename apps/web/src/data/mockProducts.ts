// NOTE: Types are defined inline in each product entry to avoid unused type imports during audit
    ...
    products: [
      {
        ...
        images: ["/images/products/notre-selection/hermes/femme/hermes-birkin-35.jpg"],
